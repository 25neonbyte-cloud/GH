import { Router } from 'express'; import { authenticate } from '../middleware/auth.js'; import { adminOnly } from '../middleware/permissions.js'; import { createBackup,listBackups,backupPath,restoreBackup } from '../services/backupService.js';
const router=Router(); router.use(authenticate,adminOnly);
